...
module.exports.settingsMenub = function (option, embed, msg, userdata) {
  console.log(option)
  ...
  if (option == "dealersort") {
    ...
    var applysetting = function (num) {
      ...
      return "**Dealership Sort** has been set to **" + list[num]["name"] + "**.";
    };
    return [list, applysetting]
  }
  ...
  if (option == "garagesort") {
    ...
    var applysetting = function (num) {
      ...
      return "**Garage Sort** has been set to **" + list[num]["name"] + "**.";
    };
    return [list, applysetting]
  }
  ...
  if (option == "displaygrid") {
    ...
    var applysetting = function (num) {
      ...
      return "**Grid Display Names** has been set to **" + list[num] + "**.";
    };
    return [list, applysetting];
  }
  ...
  if (option == "icons") {
    ...
    var applysetting = function (num) {
      var bar = list[num].split(" | ")[1].split(" ")
      var select = bar[0]

      userdata["settings"]["ICONS"] = {select:select, bar: bar};
      
      return "**Menu Icons** has been set to **" + list[num] + "**.";
    };
    return [list, applysetting]
  }
  ...
  if (option == "menuselect") {
      ...
      var applysetting = function (num) {
        ...
        return "Menu Selector has been set to **" + list[num] + "**."
      };
    return [list, applysetting]
    }
  ...
  if (option == "time") {
    var date = new Date();
    pageargs["footer"] = "❓ **What time is it? Select with the number corresponding to your current time zone (Military Time). This will reset the cycle your daily workout and race multiplier. **";
  ...
  if (option == "units") {
    ...
    var applysetting = function (num) {
      ...
      return "**Metric Units** has been set to **" + list[num] + "**."
    };
    return [list, applysetting]
  }
  ...
  if (option == "messages") {
    ...
    var applysetting = function (num) {
      ...
      return "**Career/Info Messages** has been set to **" + list[num] + "**."
    };
  }
