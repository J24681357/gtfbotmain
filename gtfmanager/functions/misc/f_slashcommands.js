...
rest.put(
  Routes.applicationCommands(gtm_USERID),
  { body: commands },
).then((data) => console.log(`GTM: Successfully registered ${commands.length} application global commands.`))
  .catch(console.error)


  /*
rest.put(Routes.applicationGuildCommands(gtm_USERID, gtm_SERVERID), { body: [] })
  .then((data) => console.log(`GTM: Successfully registered ${data.length} application guild commands.`))
  .catch(console.error)
 */
}
